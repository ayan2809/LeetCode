<h2>1049. Last Stone Weight II</h2><h3>Medium</h3><hr><div><p>You are given an array of integers <code>stones</code> where <code>stones[i]</code> is the weight of the <code>i<sup style="">th</sup></code> stone.</p>
