...
<p>Return <em>the string that represents the </em><code>k<sup style="">th</sup></code><em><strong> largest integer</strong> in </em><code>nums</code>.</p>
...
The 4<sup style="">th</sup> largest integer in nums is "3".
</pre>
...
The 3<sup style="">rd</sup> largest integer in nums is "2".
</pre>
...
The 2<sup style="">nd</sup> largest integer in nums is "0".
</pre>
