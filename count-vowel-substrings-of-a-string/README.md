<h2>2062. Count Vowel Substrings of a String</h2><h3>Easy</h3><hr><div><p>A <strong>substring</strong> is a contiguous (non-empty) sequence of characters within a string.</p>
