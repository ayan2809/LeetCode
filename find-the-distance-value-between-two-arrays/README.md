<h2>1385. Find the Distance Value Between Two Arrays</h2><h3>Easy</h3><hr><div><p>Given two integer arrays <code>arr1</code> and <code>arr2</code>, and the integer <code>d</code>, <em>return the distance value between the two&nbsp;arrays</em>.</p>
