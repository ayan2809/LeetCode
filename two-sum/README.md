...
<ul>
	<li><code>2 &lt;= nums.length &lt;= 10<sup style="">4</sup></code></li>
...
<p>&nbsp;</p>
<strong>Follow-up:&nbsp;</strong>Can you come up with an algorithm that is less than&nbsp;<code>O(n<sup style="">2</sup>)&nbsp;</code>time complexity?</div>